...
export default {
  ...
  data: () => ({
    hpersonagens: [
      {text: "Nome", sortable: true, value: 'pnome', class: 'subtitle-1'},
      {text: "Id", sortable: true, value: 'idPersonagem', class: 'subtitle-1'},
  ...
  methods: {
    mostraPersonagem: function(item){
        this.$router.push({ path: "/personagens/" + item.idPersonagem});
    }
  }
