                    ...
                    <div class="info-content">
                        <ul>
                            <li 
                                ...
                                :key="ator.idAtor"
                            >
                                <a @click="consultaAtor(ator)">{{ ator.anome }}</a>
                            </li>
                        </ul>
                    </div>
                </v-col>
                ...
                <v-col>
                    <div class="info-content">
                        <ul>
                            ...
                            >
                                <a @click="consultaPersonagem(personagem)">{{ personagem.pnome }}</a>
                            </li>
                        </ul>
                    </div>
                </v-col>
...
export default {
  ...
  methods: {
    ...
    consultaPersonagem(personagem){
        this.$router.push({ path: "/personagens/" + personagem.idPersonagem});
    }
  }
}
